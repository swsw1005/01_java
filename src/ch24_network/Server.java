    ...
    class Service extends Thread {
        ...
        public Service(Socket s) {
            try {
                 ...
                 * putMsgTo("100|211.183.0.91 이 ip 사용 불가능 합니다"); return ; }
                 */
                ...
                try {
                    ...
                    case 200: {// 방만들기
                        ...
                        if (!flag.equals(t)) {
                            ...
                            putMsgAll("200|" + myroom.title + "|" + 0);// 방이 개설
                                                                       // 되었음을
                                                                       // 모든
                                                                       // 클라이언트에게
                                                                       // 보낸다
                            putMsgAll("210|" + name + "|" + myroom.title);// 방들어왔다는
                                                                          // 것을
                                                                          // 모든
                                                                          // 클라이언트에게
                                                                          // 알린다
                    ...
                    case 290: {// 방퇴장
                        ...
                        // 클라이언트에게 보내는 메서드 호출
                        putMsgAll("290|" + name + "|" + myroom.title);// 방에서
                                                                      // 나갔음을
                                                                      // 모두에게
                                                                      // 알린다
                    ...
                    case 900: {// 종료 ( 채팅방사이트에서 나간 클라이언트 )
                        ...
                        // 모든 클라이언트 에게 보내준다
                        putMsgAll("900|" + name + "|" + myroom.title);// 모두에게
                                                                      // 알린다
