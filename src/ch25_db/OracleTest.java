...
public class OracleTest {
    ...
    public void sql_id() {
        ...
        try {
            pp.load(new FileInputStream("src\\ch25_db\\OracleDB.properties"));
        } catch (Exception ex) {
    ...
    public void test() {
        ...
        try {
            ...
            //// insert
            sql = "insert into member(id, pw, name,email) values('bb','bb123','비비','swsw@naver.com')";
            stmt.executeUpdate(sql);

            // update
            sql = "update member set name='깡 비' where id='bb'";
            stmt.executeUpdate(sql);

            // delete
            sql = "delete from member where id='bb'";
            stmt.executeUpdate(sql);
